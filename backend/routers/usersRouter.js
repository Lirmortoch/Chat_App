...
UsersRouter.post('/signup', fieldWhiteList(userList), validator(userSchema), UsersController.signupUser);

UsersRouter.put('/:public_id', fieldWhiteList(userList), validator(userSchema), UsersController.updateUserInfo);
UsersRouter.put('/access/user/:public_id', checkUserPrivileges('med-admin', 'high-admin'), fieldWhiteList(adminList), validator(chatSchema), UsersController.updateUserPrivileges);
