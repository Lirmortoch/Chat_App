...
const { checkChatAccess, fieldWhiteList, userList, adminList, checkUserPrivileges } = require('../utils/middleware.js');
...
ChatsRouter.put('/:public_id', checkChatAccess('owner', 'high-admin'), fieldWhiteList(userList), validator(chatSchema), );
ChatsRouter.put('/permissions/chat/:public_id', checkChatAccess('owner'), fieldWhiteList(adminList), validator(chatSchema), );
