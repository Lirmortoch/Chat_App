...
-- chat.photos definition

-- Drop table

-- DROP TABLE chat.photos;

CREATE TABLE chat.photos (
	...
	CONSTRAINT photos_unique UNIQUE (public_id)
);
...
CREATE TABLE chat.users (
	...
	delete_reason varchar(125) DEFAULT ''::character varying NOT NULL,
	restricted bool DEFAULT false NOT NULL,
	restrict_reason varchar(125) DEFAULT ''::character varying NOT NULL,
	"role" varchar(25) DEFAULT 'user'::character varying NOT NULL,
	public_id uuid DEFAULT uuidv7() NOT NULL,
	last_name varchar(125) DEFAULT ''::character varying NOT NULL,
	user_about varchar(125) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE chat.chats (
	...
	url varchar(65) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE chat.contacts (
	...
	phone_number varchar(25) DEFAULT ''::character varying NOT NULL,
	email varchar(135) NOT NULL,
	first_name varchar(125) NOT NULL,
	last_name varchar(125) DEFAULT ''::character varying NOT NULL,
	user_id int4 NOT NULL,
...
-- chat.messages_hidden definition

-- Drop table

-- DROP TABLE chat.messages_hidden;

CREATE TABLE chat.messages_hidden (
	message_id int4 NOT NULL,
	user_id int4 NOT NULL,
	CONSTRAINT messages_hidden_pkey PRIMARY KEY (message_id, user_id),
	CONSTRAINT messages_hidden_message_id_fkey FOREIGN KEY (message_id) REFERENCES chat.messages(id) ON DELETE CASCADE,
	CONSTRAINT messages_hidden_user_id_fkey FOREIGN KEY (user_id) REFERENCES chat.users(id) ON DELETE CASCADE
);
...
CREATE TABLE chat.sessions (
	...
	identifier uuid DEFAULT uuidv7() NOT NULL,
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	CONSTRAINT sessions_pk PRIMARY KEY (id),
	CONSTRAINT sessions_unique UNIQUE (identifier),
	CONSTRAINT sessions_user_fk FOREIGN KEY (user_id) REFERENCES chat.users(id) ON DELETE CASCADE
);
...
CREATE TABLE chat.user_profile_photos (
	...
	CONSTRAINT user_profile_photos_photos_fk FOREIGN KEY (photo_id) REFERENCES chat.photos(public_id) ON DELETE CASCADE
);
CREATE UNIQUE INDEX user_photos_one_main_per_user ON chat.user_profile_photos USING btree (user_id) WHERE (is_main = true);


-- chat.additionals definition
...
CREATE TABLE chat.additionals (
	...
	CONSTRAINT additionals_unique UNIQUE (public_id),
...
-- chat.contact_avatars definition

-- Drop table

-- DROP TABLE chat.contact_avatars;

CREATE TABLE chat.contact_avatars (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	is_main bool DEFAULT true NOT NULL,
	created_at timestamptz DEFAULT CURRENT_TIMESTAMP NOT NULL,
	...
	CONSTRAINT contact_avatars_photos_fk FOREIGN KEY (photo_id) REFERENCES chat.photos(public_id) ON DELETE CASCADE
);
